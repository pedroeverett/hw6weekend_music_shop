...
public class ShopTest {
  ...
  public void before() {
    ...
    guitar = new Guitar("Guitar 1", "Wood", "Brown", "Accoustic", 350.00, 630.00, 5, 6, "Mahogany", "The best sound ever");
    // guitar markup 80
    string = new GuitarString("Guitar Strings 1", "Classic Guitar Strings", 60, 2.50, 6.50);
    piano = new Piano("Piano 1", "Wood", "Black", "Classic", 2000.00, 4000.00, 10, 80, 3, "Fantastic string Piano");
    // piano markup 100
